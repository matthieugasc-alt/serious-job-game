 ...
 * disque, vérifie le format v2 (404 sinon), vérifie le verrouillage
 * admin (scenarioConfig → page « scénario verrouillé », pas le Shell),
 * puis délègue au client component PlayerClient qui monte le Shell
 * générique.
 *
